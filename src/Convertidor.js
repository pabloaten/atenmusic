...
const Convertidor = () => {
  ...
  fetch(`https://youtube-mp36.p.rapidapi.com/dl?id=${data}`, options)
    ...
    .then((response) => (setEnlace(response.link),setTittle(response.title,console.log(response)))
    )
  ...
  return (
    <div className="flex flex-col font-mono text-lg text-gray-800 text-center bg-white p-10 rounded-md">
